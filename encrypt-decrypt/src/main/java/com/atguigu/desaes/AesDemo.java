...
public class AesDemo {
    public static void main(String[] args) throws Exception{
        ...
        String decryptDES = decryptDES(encryptDES, key, transformation, encryptionType);
     ...
     * @throws Exception
     */
    private static String decryptDES(String encryptDES, String key, String transformation, String encryptionType) throws Exception{
        //创建加密实例    传入加密类型=>DES类型
